...
joblib.dump(features_to_use, os.path.join(model_dir, 'features.pkl'))
...
# ============================================================================
print("\n🎯 SAMPLE PREDICTIONS:")
print("\nTop 5 students most likely to be placed:")
top_indices = np.argsort(rf_pred_proba)[-5:][::-1]
for i, idx in enumerate(top_indices, 1):
    print(f"   {i}. Placement Probability: {rf_pred_proba[idx]:.2%}")

print("\nTop 5 students least likely to be placed:")
bottom_indices = np.argsort(rf_pred_proba)[:5]

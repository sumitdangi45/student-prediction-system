...
print("=" * 80)
print("STUDENT PLACEMENT PREDICTION MODEL - IMPROVED TRAINING")
print("=" * 80)
...
# Select relevant features - EXPANDED (using actual column names)
# NOTE: Removed Job Offer Count and Internship Offer Count as they are target-related
features_to_use = [
    ...
    'Total Gap In Education',  # Academic gap
    'Count of Companies Registered in - Job',  # Companies registered
    'Count of Companies Registered in - Internship',  # Internship registrations
]
...
joblib.dump(rf_model, os.path.join(model_dir, 'rf_model_v3.pkl'))
joblib.dump(gb_model, os.path.join(model_dir, 'gb_model_v3.pkl'))
joblib.dump(scaler, os.path.join(model_dir, 'scaler_v3.pkl'))
joblib.dump(le_dict, os.path.join(model_dir, 'label_encoders_v3.pkl'))
joblib.dump(features_to_use, os.path.join(model_dir, 'features_v3.pkl'))
